...
namespace lab3.Controllers
{
    public class NqtHomeController : Controller
    {
        ...
        public IActionResult NqtIndex()
        {
            ...
            {
                new NqtProduct { Id = 1, Name = "Nồi cơm điện cao tần Nagakawa NAG0102", ImageUrl = "/images/product1.jpg" },
                new NqtProduct { Id = 2, Name = "Nồi cơm điện cao tần Nagakawa NAG0102", ImageUrl = "/images/product2.jpg" },
                new NqtProduct { Id = 3, Name = "Nồi cơm điện cao tần Nagakawa NAG0102", ImageUrl = "/images/product3.jpg" }
            };
            return View();
        }
